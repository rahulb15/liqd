    ...
    <Fragment>
          ...
          <main>
            <section className="DashboardPage">
              <div className="tickets_page">
                <div className="card tickets_section">
      ...
      >
        <Box sx={modalStyle}>
          ...
          <input
            type="text"
            className="outline-none p-[10px] rounded-[5px] border-2 my-5 w-full"
            id="tickId"
            placeholder="Ticket ID"
          />

          <button className="Button primary block" onClick={searchById}>
            Search
          </button>
        </Box>
      </Modal>
