...
export default function Coins(props) {
  ...
  async function updateFee() {
    ...
    let min_deposit = Number(document.getElementById("min").value);
    let n_fee = document.getElementById("n_fee")
      ? Number(document.getElementById("n_fee").value)
      : false;
                      ...
                      return (
                        <tr key={i}>
                          ...
                          <td align="left">
                            <span className="AssetBalance right semi-bold">
                              <Switch
                                onChange={(v, newv) => updateStatus(e.id, newv)}
                                defaultChecked={e.admin_disabled}
                              />
                            </span>
                          </td>
            ...
            <Fragment>
              ...
              <div className="TextBox m-4" style={{ margin: 10 }}>
                <input
                  ...
                  step=".01"
                  id="d_fee"
                  defaultValue={selectedCoin.d_fee * 100}
                  placeholder="Value"
                />
              </div>
              <label className="mt-l" style={{ margin: 10 }}>
              ...
              <div className="TextBox m-4" style={{ margin: 10 }}>
                <input
                  ...
                  step=".01"
                  id="w_fee"
                  defaultValue={selectedCoin.w_fee * 100}
                  placeholder="Value"
                />
              </div>
              <label className="mt-l" style={{ margin: 10 }}>
              ...
              <div className="TextBox m-4" style={{ margin: 10 }}>
                <input
                  ...
                  step=".01"
                  id="e_fee"
                  defaultValue={selectedCoin.e_fee * 100}
                  placeholder="Value"
                />
              </div>
              <label className="mt-l" style={{ margin: 10 }}>
              ...
              <div className="TextBox m-4" style={{ margin: 10 }}>
                <input
                  ...
                  step=".01"
                  id="interest"
                  defaultValue={selectedCoin.interest * 100}
                  placeholder="Value"
                />
              </div>
              <label className="mt-l" style={{ margin: 10 }}>
              ...
              <div className="TextBox m-4" style={{ margin: 10 }}>
                <input
                  ...
                  step=".01"
                  id="spread"
                  defaultValue={selectedCoin.spread * 100}
                  placeholder="Value"
                />
              </div>
              <label className="mt-l" style={{ margin: 10 }}>
              ...
              <div className="TextBox m-4" style={{ margin: 10 }}>
                <input
                  type="number"
                  id="min"
                  defaultValue={selectedCoin.min_deposit}
                  placeholder="Value"
                />
              </div>
                ...
                <>
                  ...
                  <div className="TextBox m-4" style={{ margin: 10 }}>
                    <input
                      ...
                      step=".01"
                      id="n_fee"
                      defaultValue={selectedCoin.network_fee}
                      placeholder="Value"
                    />
                  </div>
                </>
