...
export default function Earn(props) {
  ...
  const html = (
    <Fragment>
                          ...
                          <tr key={i} className="earn_row">
                            ...
                            <td align="left" width={110}>
                              <a>
                                <button
                                  type="button"
                                  onClick={() => handleRejectionModal(i)}
      ...
      >
        <Box sx={styleWith} className=" items-center justify-center custom_modal_lg">
          {selectedTicket && (
            <>
              <h1 className="text-center my-3">Submit a withdraw request</h1>
              <h3 className="my-2">For Coin : {selectedTicket?.coin?.symbol}</h3>
              {selectedTicket.bank_details && (
                <>
                  <div className="field_wrapper">
                    <div className="field">
                      <label className="mt-s" style={{ margin: 10 }}>
                        Account Name
                      </label>
                      <div className="TextBox m-1" style={{ margin: 10 }}>
                        <input
                          disabled={true}
                          defaultValue={
                            selectedTicket.bank_details.account_name
                          }
                          type="text"
                          id="accountName"
                    ...
                    <div className="field">
                      ...
                      <div className="TextBox m-1" style={{ margin: 10 }}>
                        <input
                          disabled={true}
                          defaultValue={selectedTicket.bank_details.bank_name}
                          type="text"
                          id="bankName"
                  ...
                  <div className="field_wrapper">
                    <div className="field">
                      <label className="mt-s" style={{ margin: 10 }}>
                        {selectedTicket.coin.symbol === "GBP"
                          ? "Sort Code"
                          : "BIC"}
                      </label>
                      <div className="TextBox m-1" style={{ margin: 10 }}>
                        <input
                          disabled={true}
                          defaultValue={
                            selectedTicket.bank_details.sort_code
                              ? selectedTicket.bank_details.sort_code
                              : selectedTicket.bank_details.bic
                          }
                          type="text"
                          id="bankCode"
                          placeholder="Sort Code / BIC"
                        />
                      </div>
                    </div>
                    <div className="field">
                      ...
                      <div className="TextBox m-1" style={{ margin: 10 }}>
                        <input
                          disabled={true}
                          defaultValue={
                            selectedTicket.bank_details.account_number
                              ? selectedTicket.bank_details.account_number
                              : selectedTicket.bank_details.iban
                          }
                          type="text"
                          id="accountNumber"
                  ...
                  {selectedTicket.coin.symbol === "USD" && (
                    <div className="field_wrapper">
                      <div className="field">
                        <label className="mt-s" style={{ margin: 10 }}>
                          City
                        ...
                        <div className="TextBox m-1" style={{ margin: 10 }}>
                          <input
                            disabled={true}
                            defaultValue={
                              selectedTicket.bank_details.city
                            }
                            type="text"
                            id="city"
                            placeholder="City"
                      ...
                      <div className="field">
                        ...
                        <div className="TextBox m-1" style={{ margin: 10 }}>
                          <input
                            disabled={true}
                            defaultValue={selectedTicket.bank_details.country}
                            type="text"
                            id="country"
                            placeholder="Country"
                          />
              ...
              {!selectedTicket.bank_details && (
                <div className="field field_acc">
                  <label className="mt-s" style={{ margin: 10 }}>
                    Address
                  </label>
                  <div className="TextBox m-1">
                    <input
                      disabled={true}
              ...
              <div className="field field_acc">
                ...
                <div className="TextBox m-1" style={{ margin: 10 }}>
                  <input
                    disabled={true}
                    defaultValue={selectedTicket.amount}
                    type="number"
                    step=".01"
                    id="earnAmount"
                    placeholder="Value"
              ...
              <button
                type="button"
                onClick={() => approve(true, -1, selectedTicket)}
                className="Button primary my-1  w-1/5"
              >
                {" "}
                Send{" "}
              </button>
      ...
      >
        <Box className="custom_modal_sm">
          ...
          <button
            type="button"
            onClick={() => approve(false, selectedTicket)}
            className="Button primary block"
          >
            {" "}
            Reject{" "}
