...
export default function Personal(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!resp.failed) {
      ...
      Router.push("/app/user/verification");
      // getAPIToken(body);
    } else {
      if (resp.failed) {
                      ...
                      <div className="fade-in">
                        ...
                        <div className="SelectBox filter">
                          <span>
                            ...
                            <select
                              onChange={(e) =>
                                handleSelectChange(e, "employment")
                              }
                            >
                              {employments.map((e, i) => (
                                <option key={i} value={i}>
                      ...
                      {/* <div className="fade-in d-none">
                        ...
                        <div className="SelectBox filter">
                          <span>
                            ...
                            <i className="fa fa-chevron-down" />
                            <select
                              onChange={(e) => handleSelectChange(e, "crypto")}
                            >
                              {cryptos_s.map((e, i) => (
                                <option key={i} value={i}>
                                  {e.name}
                      ...
                      <div className="f1">
                        ...
                        <div className="SelectBox filter">
                          <span className="hv">
                            ...
                            <i className="fa fa-chevron-down" />
                            <select
                              onChange={(e) => handleSelectChange(e, "phone")}
                            >
                              {phone_codes.map((e, i) => (
                                <option key={i} value={i}>
                                  {e.name}
