...
export default function Confirm(props) {
  ...
  async function change(){
    ...
    if (password != confpassword){
        addToast("Password missmatch",{
            appearance: "error",
            autoDismiss:true
        })
    }else{
        let url = "recovery/change"
        let body = {
            uid,
            rid,
            password,
      ...
      <div className="Portal backdrop">
        <div className="my-5 Modal FormLogin py-3" style={{ width: 500 }}>
            ...
            <form className="mt-l">
              ...
              <label className="mt-l">New Password</label>
              <div className="TextBox">
                <input type="password" id="password" />
              </div>
              <label className="mt-l">Confirm New Password</label>
              <div className="TextBox">
